...
' attributes (list containing any attribute that according to the text can be attributed to the entities). The relationships must have the following fields: source' +
...
export default class OpenAIDavinciService {
  ...
  async generateText(text, maxTokens = 100, initialId, entityTypes) {
    let typesprompt;
